...
export default function MixAndMatchLab() {
  ...
  // Digital Magic Math: Mixes any two hex colors automatically!
  const mixColors = () => {
    const hex2rgb = (hex) => {
  ...
  return (
    <div className="bg-amber-50 rounded-xl p-8 border-4 border-amber-200 shadow-lg mt-12">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-extrabold text-amber-900">🧪 Universal Mix Magic Lab</h2>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 bg-white p-8 rounded-3xl border-2 border-gray-100 shadow-sm">
        ...
        <div className="flex flex-col items-center">
          <div
            ...
            style={{ backgroundColor: result ? result : '#F3F4F6', borderColor: result ? '#10B981' : undefined }}
          >
