...
import { ecoMissions, animalRiddles, earthFacts, spaceFacts, safariFacts } from '../../data/mikoData';
...
export default function MikoGalaxyGardenPage() {
  ...
  return (
    <div className="character-page-button-fix min-h-screen bg-gradient-to-br from-slate-950 via-emerald-950 to-slate-900 px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
