...
import { fitnessMissions, foodFacts } from '../../data/nikoData';
...
export default function NikoFriendshipHavenPage() {
  ...
  return (
    <div className="character-page-button-fix min-h-screen bg-gradient-to-br from-slate-900 via-rose-950 to-slate-900 px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
