  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-fuchsia-900 via-slate-900 to-rose-900 px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-7xl space-y-6">
        <header className="rounded-2xl border border-pink-400/70 bg-slate-900/70 p-4 shadow-[0_0_28px_rgba(236,72,153,0.35)] sm:p-6">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <button
              type="button"
              onClick={handleBackToLearningZone}
              className="rounded-xl border border-pink-300/70 bg-pink-500/15 px-4 py-2 text-sm font-black text-pink-100 transition hover:bg-pink-500/30"
            >
        ...
        <section className="rounded-2xl border border-pink-400/60 bg-slate-900/65 p-4 shadow-[0_0_24px_rgba(236,72,153,0.3)] sm:p-6">
          <h2 className="text-lg font-black text-pink-200 sm:text-xl">Why/How Magic Book</h2>

          <div className="mt-4 rounded-2xl border border-pink-300/60 bg-gradient-to-br from-rose-100/95 to-pink-100/95 p-4 text-slate-800 shadow-[inset_0_0_0_1px_rgba(244,114,182,0.35)] sm:p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {revealStep < 1 && (
                <button
                  ...
                  className="rounded-xl border border-pink-300 bg-pink-500/20 px-4 py-3 text-sm font-black text-pink-900 transition hover:bg-pink-500/30"
                >
                  1. Sun heats water ☀️
                </button>
              )}
        ...
        <section className="rounded-2xl border border-pink-400/60 bg-slate-900/65 p-4 shadow-[0_0_24px_rgba(236,72,153,0.3)] sm:p-6">
          ...
          <div className="mt-4 rounded-2xl border border-pink-300/50 bg-slate-800/70 p-5">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-3">
              <button
                ...
                className="rounded-xl border border-pink-300 bg-pink-500/20 px-5 py-3 text-base font-black text-pink-100 transition hover:bg-pink-500/35"
              >
                Triangle 🔺
              </button>
              <button
        ...
        <section className="rounded-2xl border border-pink-400/60 bg-slate-900/65 p-4 shadow-[0_0_24px_rgba(236,72,153,0.3)] sm:p-6">
          ...
          <div className="mt-4 rounded-2xl border border-pink-300/50 bg-slate-800/70 p-4">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-3">
              {PATTERN_CHOICES.map((choice) => (
                <button
                  ...
                  className="rounded-xl border border-pink-300 bg-pink-500/20 px-5 py-3 text-2xl font-black text-pink-100 transition hover:bg-pink-500/35"
                >
                  {choice}
                </button>
              ))}
